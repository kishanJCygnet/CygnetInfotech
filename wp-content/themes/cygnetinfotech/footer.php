			...
			<div class="container">				
				<div class="footer-contents d-flex justify-content-between align-items-center">
					...
					<div class="footer-logo">
						<a href="<?php echo site_url(); ?>" title="CygnetInfotech" alt="CygnetInfotech">
							<span class="visually-hidden">CygnetInfotech</span>
							<img src='<?php echo get_field("footer_logo", "option"); ?>' alt="CygnetInfotech">
						</a>
					</div>
					<!-- Footer logo end -->
					<div>
